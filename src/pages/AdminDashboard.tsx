...
const AdminDashboard = () => {
  ...
  const handleCreateCadetAccount = async (e: React.FormEvent) => {
    ...
    try {
      // First, create the cadet record with all fields
      const { data: cadetData, error: cadetError } = await supabase
        .from('cadets')
        .insert({
          name_full: newCadet.fullName,
          name_with_initials: newCadet.nameWithInitials || newCadet.fullName,
          application_number: newCadet.applicationNumber,
          date_of_birth: newCadet.dateOfBirth,
          platoon: newCadet.platoon,
          national_id: newCadet.nationalId || null,
          permanent_address: newCadet.permanentAddress || null,
          postal_address: newCadet.postalAddress || null,
          blood_group: newCadet.bloodGroup || null,
          height_cm: newCadet.heightCm ? parseInt(newCadet.heightCm) : null,
          chest_cm: newCadet.chestCm ? parseInt(newCadet.chestCm) : null,
          skills_talents: newCadet.skillsTalents || null,
          rector_recommendations: newCadet.rectorRecommendations || null,
          master_remarks: newCadet.masterRemarks || null,
          rank: 'Cadet'
        })
        .select()
        .single();
          ...
          <TabsContent value="create-account">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Create login credentials for a new cadet and their detailed information
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleCreateCadetAccount} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        id="nameWithInitials"
                        value={newCadet.nameWithInitials}
                        onChange={(e) => setNewCadet({ ...newCadet, nameWithInitials: e.target.value })}
                        placeholder="J. Doe"
                      />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        id="nationalId"
                        value={newCadet.nationalId}
                        onChange={(e) => setNewCadet({ ...newCadet, nationalId: e.target.value })}
                    ...
                    <div className="space-y-2">
                      ...
                      <select
                        id="bloodGroup"
                        value={newCadet.bloodGroup}
                        onChange={(e) => setNewCadet({ ...newCadet, bloodGroup: e.target.value })}
                        className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                      >
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        id="heightCm"
                        type="number"
                        value={newCadet.heightCm}
                        onChange={(e) => setNewCadet({ ...newCadet, heightCm: e.target.value })}
                        placeholder="170"
                      />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        id="chestCm"
                        type="number"
                        value={newCadet.chestCm}
                        onChange={(e) => setNewCadet({ ...newCadet, chestCm: e.target.value })}
                        placeholder="85"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Textarea
                        id="permanentAddress"
                        value={newCadet.permanentAddress}
                        onChange={(e) => setNewCadet({ ...newCadet, permanentAddress: e.target.value })}
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        id="postalAddress"
                        value={newCadet.postalAddress}
                        onChange={(e) => setNewCadet({ ...newCadet, postalAddress: e.target.value })}
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        id="skillsTalents"
                        value={newCadet.skillsTalents}
                        onChange={(e) => setNewCadet({ ...newCadet, skillsTalents: e.target.value })}
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="rectorRecommendations">Rector Recommendations</Label>
                      <Textarea
                        id="rectorRecommendations"
                        value={newCadet.rectorRecommendations}
                        onChange={(e) => setNewCadet({ ...newCadet, rectorRecommendations: e.target.value })}
                        placeholder="Rector's recommendations"
                        rows={3}
                      />
                    </div>

                    <div className="space-y-2">
                      <Label htmlFor="masterRemarks">Master Remarks</Label>
                      <Textarea
                        id="masterRemarks"
                        value={newCadet.masterRemarks}
                        onChange={(e) => setNewCadet({ ...newCadet, masterRemarks: e.target.value })}
                        placeholder="Master's remarks"
                        rows={3}
                      />
                    </div>
                  </div>
